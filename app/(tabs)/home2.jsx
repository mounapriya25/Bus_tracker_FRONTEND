...
export default function Index() {
  ...
  useEffect(() => {
    setTheme({
      ...
      arrowIcon: light
        ? require("../images/icons8-double-arrow-100.png")
        : require("../images/icons8-double-arrow-100.png"),
    });
  }, [light]);
        ...
        <>
          ...
          >
            ...
            <View style={{ padding: 10, paddingLeft: 20, backgroundColor: theme.bgColor }}>
              ...
              >
                <Image source={require("../images/icons8-home-100.png")} style={{ height: 25, width: 25, marginRight: 15 }} />
                <Text style={{ fontSize: 18, fontWeight: "600", color: theme.TtColor }}>Home</Text>
              </TouchableOpacity>
